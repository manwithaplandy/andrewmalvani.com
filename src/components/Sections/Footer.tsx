...
const Footer: FC = memo(() => (
  <footer className="relative bg-neutral-950 px-4 pb-6 pt-12 sm:px-8 sm:pb-8 sm:pt-14">
    <div className="absolute inset-x-0 -top-4 flex justify-center sm:-top-6">
      <a
        className="rounded-full border border-neutral-700/60 bg-neutral-900 p-1 text-orange-400 ring-orange-400 ring-offset-2 ring-offset-neutral-900 transition-colors hover:border-orange-400/60 focus:outline-none focus:ring-2 sm:p-2"
        href={`/#${SectionId.Hero}`}>
    ...
    <div className="flex flex-col items-center gap-y-6">
      ...
      <span className="text-sm text-neutral-500">© {currentYear} Andrew Malvani</span>
    </div>
  </footer>
));
